 ...
 *
 */
public class FieldCount extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		try {
			...
			Job job = Job.getInstance(conf, FieldCount.class.getSimpleName());
	...
	public static void main(String[] args) {
		try {
			ToolRunner.run(new FieldCount(), args);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
